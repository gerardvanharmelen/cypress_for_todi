...
Feature: Set TestMode 
  ...
  Scenario: Enable Test Mode by setting date and time for create
    ...
    And   Tree is already open so I navigate to the Test Mode Date and set to "08/03/2021"
    And   Tree is already open so I navigate to the Test Mode Time and set to "11:30 AM"
